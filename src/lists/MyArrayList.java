...
//        return oldValue;
    ...
    public boolean contains(T value) {
        ...
        return indexOf(value) >= 0;  // короткая запись написанного снизу 237-247
                                     // indexOf() ищет по индексу
//        int index = indexOf(value);
//        if (index >= 0 ) {  // нашёл такое значение
//            // Элемент найден
//            return true;
//        }
//        else {  // если ненашёл
...
//        }
    ...
    Один метод Iterator<T> iterator() - возвращает итератор для коллекции
 ...
 */
    ...
    private class MyIterator implements Iterator<T> {
        ...
        public T next() {
              ...
              return array[currentIndex++]; // короткая форма
