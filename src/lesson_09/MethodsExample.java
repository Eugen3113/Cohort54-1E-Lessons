...
public class MethodsExample {
    ...
    public static void printNumbers(int number){
        ...
        System.out.println();
                       ...
                       // 1 может быть два метода с одним названием, но РАЗНЫЕ ПАРАМЕТРЫ. Метод printArray, параметры (String[] strings)
                       //   - массив строк
    ...
    // Метод который красиво выводит массив в консоль
                          // 2 может быть два метода с одним названием, но РАЗНЫЕ ПАРАМЕТРЫ
                          // - массив интов
    ...
    public static void printChars(String str) {
        int i = 0;
        while (i < str.length()) {          // While-  В то время как ! пока...
            char ch = str.charAt(i);        // Char - символ
