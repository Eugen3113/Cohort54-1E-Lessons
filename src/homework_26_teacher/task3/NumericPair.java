package homework_26_teacher.task3;
...
public class NumericPair <T extends Number, E extends Number> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doublePair.sum()); // Вывод: 9.5

        System.out.println("_____________");

        NumericPair<Double, Double> doublePair2 = new NumericPair<>(5.5, 4.8);
        System.out.println(doublePair2.sum()); // Вывод: 10.3
    }
