...
public class InterfacesExample {
    ...
    public static void main(String[] args) {
        ...
        res = filterListByPredicate(list, i -> i > 5 && i % 2 == 0); // сравниваем на четность
        System.out.println("filterListByPredicate(list, i -> i % 2 == 0): " + res);//список всех четных чисел больше 5 и сравниваем на четность// [34, 10]

        System.out.println("\n =================1=");

        Predicate<String> isLengthGreaterThan4 = str -> str.length() > 4; // проверка длинны строки > 4 символов  // false
        Predicate<String> isContainsJava = str -> str.contains("Java");   // проверка содержит ли строка слово Java
        ...
        // R apply(T t)   - основной (абстрактный) метод функционального интерфейса Function - возвращает результат операции над объектом типа T
