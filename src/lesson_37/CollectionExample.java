...
public class CollectionExample {
    public static void main(String[] args) {
       ...
       */
        ...
        Collection<Integer> colA = new ArrayList<>(); // это неизменяемая коллекция (которую нельзя модифицировать)
        Collection<Integer> colB = new ArrayList<>(); // это неизменяемая коллекция (которую нельзя модифицировать)
        colA.addAll(List.of(10, 20, 30, 20, 40, 50, 60)); // добавляем в коллекцию
        colB.addAll(List.of(20, 30, 40, 100));             // добавляем в коллекцию
        System.out.println("colA: " + colA);              // выводим коллекцию
        System.out.println("colB: " + colB);
        colA.retainAll(colB);                              // оставляем в коллекции только те элементы, которые содержаться в коллекции colB
        System.out.println("colA.retainAll(colB): " + colA); // выводим коллекцию
//        colB.retainAll(colA);
//        System.out.println("colB: " + colB);
