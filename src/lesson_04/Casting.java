...
public class Casting {
    public static void main(String[] args) {
        ...
        // когда значение меньшего типа данных преобразуется в большой тип данных
        ...
        double test = 9_000_000_000_000_000_000_000_000_000_000.00;
        ...
        double double1 = 42.9;
        int int1 = (int) double1; // Явное преобразоввание double в int
        ...
        // Если в выражении есть хотя бы одно значение с плавающей точкой (float / double),
        // то все целочисленные типы в этом выражении кастируются к типу double

        System.out.println("result: " + result);


        // 20.0f / 7.0f = 2.85f -> 2.8571 (double)
