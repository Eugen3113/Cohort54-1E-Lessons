...
public class CatApp {
    public static void main(String[] args) {
        ...
        System.out.println(cat.toString());   // toString()- возвращает строку

        //  System.out.println(cat.name); // name не доступно, так как помечено как private (cat.name-доступ к полям)
