...
public class ForLoopExample {
    public static void main(String[] args) {
        ...
        // Для цикла for ни один из блоков не является обязательным.без условий
//        for (; ; ) {
...
//        }
        ...
        // В блоке инициализации может быть переменная любого типа
                        // Hello =5 букв, выведется 5 раз Hello,Hello$,Hello$$,Hello$$$,Hello$$$$
        ...
        int k = 14;    //ниже объявили(создали) перем-ю а=0 после запятой объявили пер-ю f=1
        for (int a = 0, f = 1; k >= 0 && f < 10; k--, a = ++a + k, f++) {  //k--, a = ++a + k, f++  -просто вычисления.без смысла
...
//        int rand = random.nextInt(4, 11); // задаём на прямую границы от 4 до 100
//        System.out.println("rand: " + rand);

        System.out.print("[");
        for (int i = 0; i < ints.length; i++) {
            ints[i] = random.nextInt(101) - 50; // (0..100) - 50 -> (-50, 50) //Заполнить массив случай-ми числами от -50 до 50 включи-но
        ...
        for (int i = 0; i < 7; i++) {
            ...
            if (i == 5) continue;    // continue - прервать текущую итерацию цикла
        ...
        while (j < 7) {
            ...
            if (j == 3) {
                j++;   // прописываем j++ ещё тут ,а то программа собъётся
                continue;
            }
