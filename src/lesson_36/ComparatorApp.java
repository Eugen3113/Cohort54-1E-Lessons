...
public class ComparatorApp {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(cars));                     // [Alfa, BMW, Citroen, Ferrari, Ferrari, VW]
        Arrays.sort(cars);
...
//        Интерфейс Comparator<T> -
         ...
         */
        System.out.println("===================== \n");
        CarSpeedComparator carSpeedComparator = new CarSpeedComparator();    //  это объект класса CarSpeedCompartor
        Arrays.sort(cars, carSpeedComparator);                             // сортировка машин по скорости
        System.out.println(Arrays.toString(cars));
...
//        реализуют интерфейс Comparable
        ...
        System.out.println("===================== \n");
//        Анонимны класс - это класс, для создания объекта на лету - без явного объявления нового класса.
